 ...
 */
V192DecoderHandle v192_create(const char* calib_file);

/** Destroy a decoder instance and free all resources. */
void v192_destroy(V192DecoderHandle h);
...
void v192_set_frame_callback(V192DecoderHandle h,
 ...
 */
int  v192_start_online(V192DecoderHandle h, uint16_t msop_port);

/** Stop the receive thread started by v192_start_online(). */
void v192_stop(V192DecoderHandle h);
 ...
 * @return 0 on success, -1 on error.
 */
int v192_open_pcap(V192DecoderHandle h, const char* pcap_file);
 ...
 *         -1  Error.
 */
int v192_read_next_frame(V192DecoderHandle h);

/**
 * Close the pcap file opened by v192_open_pcap().
 * Safe to call even if no file is open.
 */
void v192_close_pcap(V192DecoderHandle h);
 ...
 */
int v192_feed_packet(V192DecoderHandle h, const uint8_t* data, size_t len);
 ...
 */
void v192_set_distance_range(V192DecoderHandle h, float min_m, float max_m);
